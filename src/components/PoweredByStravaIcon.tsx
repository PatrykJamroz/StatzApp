interface PoweredByStravaIconProps {
  size: number;
  fill: string;
}

export function PoweredByStravaIcon(props: PoweredByStravaIconProps) {
  return (
    <svg
      id="strava_outlined"
    ...
    >
      ...
      <path
        fill={props.fill}
        d="M7.55,22.8V16.5h2.51a2.25,2.25,0,0,1,1.56.53,1.86,1.86,0,0,1,.59,1.46,1.86,1.86,0,0,1-.58,1.44,2.23,2.23,0,0,1-1.57.53H8.61V22.8H7.55Zm1.06-3.32H10a1.14,1.14,0,0,0,.77-0.27,1,1,0,0,0,0-1.49A1.23,1.23,0,0,0,10,17.48H8.61v2Z"
      />
      <path
        fill={props.fill}
        d="M17.11,22.75a2.83,2.83,0,0,1-2,0,2.63,2.63,0,0,1-.86-0.57,2.6,2.6,0,0,1-.62-1,4.78,4.78,0,0,1-.22-1.53,3.33,3.33,0,0,1,.8-2.38,2.55,2.55,0,0,1,1.92-.85,2.52,2.52,0,0,1,1.9.85,3.36,3.36,0,0,1,.8,2.39,4.78,4.78,0,0,1-.22,1.53,2.64,2.64,0,0,1-.61,1A2.53,2.53,0,0,1,17.11,22.75Zm-2.17-1.37a1.46,1.46,0,0,0,2.32,0,2.88,2.88,0,0,0,.45-1.78,2.64,2.64,0,0,0-.46-1.67,1.43,1.43,0,0,0-2.29,0,2.61,2.61,0,0,0-.46,1.67A2.89,2.89,0,0,0,14.94,21.38Z"
      />
      <path
        fill={props.fill}
        d="M21.22,22.8L20,16.5H21.1L22,20.93h0l1.49-4.44h0.6l1.48,4.44h0l0.85-4.44h1.06l-1.21,6.3H25.17l-1.42-4.32h0l-1.4,4.32H21.22Z"
      />
      <path
        fill={props.fill}
